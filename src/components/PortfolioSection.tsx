          ...
          {wall.map((image, i) => (
            ...
            >
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0F0F0E]/85 via-transparent to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                <div className="absolute inset-x-0 bottom-0 translate-y-3 p-5 opacity-0 transition-all duration-500 ease-out-expo group-hover:translate-y-0 group-hover:opacity-100">
                  ...
                  <h3 className="mt-1 flex items-center gap-1.5 font-display text-lg font-medium text-[#F5F0EB]">
                    {image.title}
